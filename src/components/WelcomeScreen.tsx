...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onInitialize }) => {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center relative overflow-hidden font-body text-on-surface">
      {/* Top Nav */}
      <motion.div 
      ...
      >
        <div className="flex items-center gap-2 text-primary-container font-bold text-xl tracking-tighter">
      ...
      <div className="flex flex-col items-center z-10 w-full px-4">
        ...
        >
          <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-3xl border border-primary-container/20 bg-primary-container/5 flex items-center justify-center shadow-[0_0_50px_rgba(0,255,171,0.1)]">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-4 border-primary-container shadow-[0_0_20px_rgba(0,255,171,0.5)]"></div>
          </div>
        </motion.div>
        ...
        <motion.p 
          ...
          className="text-outline tracking-[0.15em] sm:tracking-[0.3em] text-[10px] sm:text-xs md:text-sm uppercase mb-12 sm:mb-16 text-center"
        >
        ...
        >
          <input
            ...
            className="w-full bg-surface-container border border-outline-variant/30 text-on-surface px-6 py-4 font-mono text-sm tracking-widest uppercase focus:outline-none focus:border-primary-container transition-colors text-center placeholder:text-outline/50"
          />
          <button
            type="submit"
            disabled={isLoading || !username.trim()}
            className="w-full bg-primary-container text-on-primary-fixed px-6 py-4 font-bold tracking-[0.1em] uppercase text-xs sm:text-sm transition-all cursor-pointer rounded-sm hover:bg-primary-container/90 disabled:opacity-50 disabled:cursor-not-allowed"
          >
